...
This article will show you how to configure and use [Spring Session](https://projects.spring.io/spring-session/) to manage session data in your web application. Please checkout the code from the following [GitHub repository](https://github.com/svlada/springsession-jdbc).
